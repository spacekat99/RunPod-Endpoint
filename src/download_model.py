...
Environment variables:
    HF_MODEL_REPO:      HuggingFace repo ID (default: spacekat99/qwen3.6-27b-test3-Q8_0-GGUF)
    HF_MODEL_FILE:      GGUF filename pattern to match (default: qwen3.6-27b-test3-q8_0.gguf)
...
def main():
    repo_id = os.environ.get("HF_MODEL_REPO", "spacekat99/qwen3.6-27b-test3-Q8_0-GGUF")
    filename = os.environ.get("HF_MODEL_FILE", "qwen3.6-27b-test3-q8_0.gguf")
