...
Environment variables:
    ...
    HF_MODEL_FILE:      GGUF filename pattern to match (default: 32B-Qwen2.5-Kunou-v1.Q8_0.gguf)
...
def main():
    ...
    filename = os.environ.get("HF_MODEL_FILE", "32B-Qwen2.5-Kunou-v1.Q8_0.gguf")
