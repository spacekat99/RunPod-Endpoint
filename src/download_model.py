...
Environment variables:
    HF_MODEL_REPO:      HuggingFace repo ID (default: TheDrummer/Skyfall-31B-v4.2-GGUF)
    HF_MODEL_FILE:      GGUF filename pattern to match (default: Skyfall-31B-v4y-Q5_K_M.gguf)
...
def main():
    repo_id = os.environ.get("HF_MODEL_REPO", "TheDrummer/Skyfall-31B-v4.2-GGUF")
    filename = os.environ.get("HF_MODEL_FILE", "Skyfall-31B-v4y-Q5_K_M.gguf")
