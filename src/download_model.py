...
Environment variables:
    HF_MODEL_REPO:      HuggingFace repo ID (default: mradermacher/32B-Qwen2.5-Kunou-v1-GGUF)
    HF_MODEL_FILE:      GGUF filename pattern to match (default: 32B-Qwen2.5-Kunou-v1.Q5_K_M.gguf)
...
def main():
    repo_id = os.environ.get("HF_MODEL_REPO", "mradermacher/32B-Qwen2.5-Kunou-v1-GGUF")
    filename = os.environ.get("HF_MODEL_FILE", "32B-Qwen2.5-Kunou-v1.Q5_K_M.gguf")
